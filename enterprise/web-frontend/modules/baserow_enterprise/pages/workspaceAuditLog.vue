<template>
  ...
  import AuditLogWorkspaceService from '@baserow_enterprise/services/auditLogWorkspace'
  ...
  export default {
    ...
    data() {
      ...
      this.service = AuditLogWorkspaceService(this.$client, parseInt(this.$route.params.workspaceId))
      return {
        filters: {},
