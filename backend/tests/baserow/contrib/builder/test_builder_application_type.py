...
def test_builder_application_export(data_fixture):
    ...
    element1 = data_fixture.create_builder_heading_element(
        page=page1, level=2, value={"type": "plain", "expression": "foo"}
    )
            ...
            "elements": [
                {
                    ...
                    "type": "heading",
                    "order": 1,
                    "value": {"type": "plain", "expression": "foo"},
                    "level": 2,
                },
                {
                    "id": 999,
...
def test_builder_application_import(data_fixture):
    ...
    builder = BuilderApplicationType().import_serialized(group, IMPORT_REFERENCE, {})
