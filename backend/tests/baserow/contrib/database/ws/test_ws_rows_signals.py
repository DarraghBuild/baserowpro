...
def test_rows_history_updated(
    mock_broadcast_channel_group, mock_row_page_broadcast_channel_group, data_fixture
):
    user = data_fixture.create_user()
    table = data_fixture.create_database_table(user=user)
    field = data_fixture.create_text_field(table=table)
    ...
    assert mock_broadcast_channel_group.mock_calls == table_broadcast_calls
    ...
    assert mock_row_page_broadcast_channel_group.mock_calls == row_page_calls
