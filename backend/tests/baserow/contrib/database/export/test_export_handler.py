...
def test_can_export_every_interesting_different_field_to_csv(
    ...
    expected = (
        ...
        "formula_link_url_only,count,rollup,lookup,uuid,autonumber\r\n"
        ...
        f"2020-01-01,,,label (https://google.com),https://google.com,0,0.000,,{uuid},1\r\n"
        ...
        '3,-122.222,"linked_row_1,linked_row_2,",00000000-0000-0000-0000-000000000000,2\r\n'
    )
