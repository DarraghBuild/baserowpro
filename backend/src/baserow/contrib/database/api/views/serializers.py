...
def serialize_group_by_meta_data(
    group_meta_data: Dict[Field, List[Dict[str, Any]]]
) -> Dict[str, List[Dict[str, Any]]]:
    """
    Serializes the structure generated by the `get_group_by_meta_data_in_rows`
    ...
    :param group_meta_data: The object that must be serialized
    :return:
    """

    serializer_mapping = {}

    for field in group_meta_data.keys():
    ...
    for field, data in group_meta_data.items():
        for entry in data:
