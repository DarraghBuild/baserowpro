...
class FieldType(
    ...
    def get_fields_needing_periodic_update(self) -> Optional[QuerySet]:
        ...
        This method returns all the formula fields that needs to be updated
        periodically and that have no dependencies, because `run_periodic_update`
        will update all the fields that depend on it.

        :param group_id: The id of the group to filter on.
