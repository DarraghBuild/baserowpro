...
class AppAuthProviderType(EasyImportExportMixin, BaseAuthProviderType):
    ...
    def user_source_is_compatible(self, user_source, raise_exception=True):
        """
        ...
        :param rais_exception: Whether to raise an exception instead of returning a
          value.
        :return: True if the user_source is compatible, False otherwise.
        """
